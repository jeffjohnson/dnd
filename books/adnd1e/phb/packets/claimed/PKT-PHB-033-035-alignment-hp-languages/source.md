...
All of the above may not normally be available due to campaign circumstances, and languages not listed might be common. Consult your Dungeon Master. Note that if, for example, you capture a centaur or talking dragon of some sort, it is possible to learn the appropriate creature tongue. {#p35}